# Brazilian E-Commerce Analytics and Business Optimization (Olist Dataset)

## Executive Summary

This project analyzes **100,000+ orders** from **Olist** (2016 to 2018) by integrating 11 relational datasets and NLP review intelligence to evaluate revenue growth, logistics bottlenecks, customer satisfaction, and seller dynamics.

### Core Takeaways
- **Retention Gap:** Over **90% of customers are one-time buyers**, representing the largest untapped revenue opportunity.
- **Logistics and RCA:** Delivery delays are the #1 driver of 1-star reviews. Root cause analysis isolates the early 2018 crisis to carrier transit times (+38% delay), rather than seller dispatch.
- **Geographic Disparity:** 60% of sellers are concentrated in São Paulo, driving up freight costs and delivery times for high-demand states like RJ and MG.
- **Revenue Concentration:** Just 17 of 70+ categories generate **80% of total revenue** (led by Health and Beauty and Watches and Gifts).
- **Review Drivers:** Customer satisfaction is driven primarily by on-time delivery and catalog accuracy.

### Data Sources
- **Olist Dataset:** [Olist Brazilian E-Commerce Dataset on Kaggle](https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce)
- **Translated Reviews Dataset:** [Olist Order Reviews Translated on Kaggle](https://www.kaggle.com/datasets/pavelgrigoryev/olist-order-reviews-translated)
...
### Key Objectives
- **Growth and Retention:** Track revenue trends, Black Friday peaks, and repeat purchase patterns.
...
<div align="center">
 ...
 <p><em>Database Schema: Olist Relational Architecture across all 11 tables.</em></p>
</div>
...
## Business Insights and Visual Analytics

### 1. Revenue and Order Growth Trends

<div align="center">
 <img src="./Chart/Acquisition_Trend.png" alt="Customer Acquisition Trend" width="85%" style="border-radius: 8px; margin-bottom: 15px;" />
 <p><em>Figure 1: Customer Acquisition and Onboarding Trajectory Over Time.</em></p>
</div>
...
<div align="center">
 ...
 <p><em>Figure 2: Customer Order Frequency and Order Count Distribution.</em></p>
</div>
...
<div align="center">
 ...
 <p><em>Figure 3: Revenue and Freight Cost Comparison Over Time.</em></p>
</div>
...
- **Freight and Revenue Alignment:** Total freight spend moved in lockstep with gross sales, indicating stable shipping rates over the period.
- **Volume Plateau:** By 2018, platform demand matured at a steady run rate of **6,000 to 7,000 orders per month**.

---

### 2. Delivery Performance and Customer Ratings
...
- **Impact of Lost and Canceled Orders:** Tracking canceled and lost-in-transit shipments is essential, as these directly erode GMV and increase support overhead.
...
- **Regional Delivery and Freight Differences:** Shipping times and freight costs vary significantly by state. Interstate deliveries take longer and cost more than local intrastate fulfillment. Strategic routing and regional stocking can help reduce these delays.

<div align="center">

#### Logistics and Goods Price Correlation Matrix
...
### 3. Root Cause Analysis of Late Deliveries in February and March 2018
...
- **The Early 2018 Delivery Crisis:** While platform late delivery rates averaged 6.59% historically (October 2016 to January 2018), February and March 2018 experienced massive operational friction. Late delivery rates spiked to **2.4x and 3.2x baseline levels**, coinciding with all-time monthly peaks in canceled and stuck in-transit orders.
- **Stage-by-Stage Timeline Isolation:** Decomposing fulfillment into three distinct phases (Purchase to Approval, Approval to Carrier Hand-off, and Carrier to Customer Delivery) reveals that platform payment approval and seller dispatch times remained completely stable during the crisis.
- **Carrier-Driven Logistics Breakdown:** The entire delay occurred during the **Carrier-to-Delivery stage**, where transit times surged by **38% in February** and **34% in March 2018** compared to baseline.
- **Operational Takeaway:** The delivery crisis was not driven by vendor fulfillment lags or platform processing delays, but by third-party carrier network disruptions and freight carrier bottlenecks during early 2018.

---


### 4. Product Performance and Market Basket Analysis
...
#### Key Findings
- **Top Revenue Drivers:** **Health and Beauty** generated the most revenue (>BRL 1.2M), followed closely by **Watches and Gifts** and **Bed, Bath and Table**.
- **Pareto Principle in Action:** Out of more than 70 product categories, just **17 categories generate 80% of total revenue**.
- **Cross-Category Buying Habits:** The strongest co-purchasing happens within Home Improvement, especially **Furniture and Decor** alongside **Bed, Bath and Table**. A secondary cluster appears around **Baby, Toys, and Cool Stuff**.
...
---
### 5. Purchase Seasonality and Temporal Heatmaps
...
- **Category-Specific Seasonality:**
 ...
 - **Early-Year Tech Spending:** **Computers and Accessories** peaked early in the year (crossing 1,000 orders in February), matching post-holiday upgrades and company IT refresh cycles.
 - **Mid-Year Everyday Goods:** **Bed, Bath and Table** and **Health and Beauty** provided steady baseline volume year-round, peaking between May and August.
...
### 6. Geographic Supply and Demand
...
- **Translated English Equivalents:** **`product`**, **`delivery`**, **`deadline`**, **`time`**, **`fast`**, and **`quality`**.
...
### 8. Seller Economics and Fulfillment Analytics
...
### 9. Payment Preferences and Installments
